    ...
    <div class="container">
        <div class="row justify-content-between align-items-center mb-2">
            ...
            <div class="col-md-4 justify-content-between">
                <!-- Logo --> <!-- Trademark -->
                <div class="justify-content-center text-light align-items-center">
                    <div class="navbar-brand mx-auto d-none d-md-block">
                        <img src="../assets/images/CMHlogo.png" alt="Logo" class="navbar-logo">
                    </div>
                    <p><small><em>&copy; 2023 MyAutoCare, designed by <a href="#" class="link-light">OmeDesign</em></a></small></p>
                </div>
            </div>
        </div>
    </div>
