<div class="d-flex align-items-center">
    <div class="login-box has-form">
        <h5 class="text-light text-center mb-2 text-decoration-underline">Please choose a login method</h5>
        ...
        <div class="form-floating mb-3 fade slow-fade show" id="email-input-wrapper">
        ...
        <div class="form-floating mb-3 fade slow-fade d-none" id="phone-input-wrapper">
            <div class="form-floating mb-3 d-none" id="phone-input">
        ...
        <div class="form-floating mb-3 fade slow-fade d-none" id="idnumber-input-wrapper">
            <div class="form-floating mb-3 d-none" id="idnumber-input">
